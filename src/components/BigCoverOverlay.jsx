  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#09090e] text-white flex flex-col justify-between p-6 sm:p-10 select-none overflow-hidden animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="relative z-10 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* Switcher Buttons: Cover Art, Lyrics, Visualizer */}
      ...
      {/* Bottom Audio Player Controls & Progress Bar */}
      <div className="relative z-10 w-full max-w-3xl mx-auto space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <button
              onClick={togglePlay}
              className="w-14 h-14 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white flex items-center justify-center shadow-xl shadow-indigo-600/50 hover:scale-105 transition-all"
            >
              {isPlaying ? (
